...
public class reject_CCenter extends DalBaseProcess {
	...
	public void doExecute(ProcessBundle bundle) throws Exception {
		...
		try {
			...
			observation = "Rechazar: " + observation;
			...
			objCreditOperation.setCallCenterStatus("R");
			objCreditOperation.setSComStatus("R");
			objCreditOperation.setCom2Status("R");
			objCreditOperation.setCom1Status("R");

			objCreditOperation.setDocumentStatus("R");
			...
			msg.setMessage("Se ha rechazado la operación de Crédito");
